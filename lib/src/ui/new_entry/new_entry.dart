import 'dart:math';
import 'package:eazyydoctor/src/common/covert_time.dart';
import 'package:eazyydoctor/src/global_bloc.dart';
import 'package:eazyydoctor/src/models/errors.dart';
import 'package:eazyydoctor/src/models/medicine.dart';
import 'package:eazyydoctor/src/models/medicine_type.dart';
import 'package:eazyydoctor/src/ui/homepage/homepage.dart';
import 'package:eazyydoctor/src/ui/new_entry/new_entry_bloc.dart';
import 'package:eazyydoctor/src/ui/success_screen/success_screen.dart';
...
class _NewEntryState extends State<NewEntry> {
  ...
  Future scheduleNotification(Medicine medicine) async {
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? MyThemeData.primaryColor: Colors.white,
            ),
            child: Center(
              child: Padding(
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: MyThemeData.primaryColor),
          ),
        ]),
      ),
    );
